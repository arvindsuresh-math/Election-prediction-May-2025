...
class DataHandler:
    ...
    def __init__(self, test_year: int = 2020, features_to_drop=['P(C)', 'log_odds_dem_rep']):
        ...
        print(f"DataHandler initialized - Using {self.n_features} features - Test year: {self.test_year}")
    ...
    def _make_dirs(self):
        ...
        self.preds_dir = os.path.join(results_dir, "preds")
